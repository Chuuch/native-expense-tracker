  ...
  return (
    <View className='flex-1 bg-stone-950 pt-20'>
      ...
      <View className='flex-row items-center justify-between w-full p-4'>
        ...
        <Text className='text-white text-4xl font-bold'>About App</Text>
      ...
      >
        ...
        <View className='flex flex-col items-center justify-center w-full bg-stone-800 rounded-xl p-6'>
          ...
          <View className='flex-row items-center gap-4'>
            ...
            <Text className='text-gray-400 text-sm'>Build 153</Text>
          </View>
        </View>

        {/* App Stats */}
        <View className='w-full'>
          <Text className='text-white text-xl font-bold mb-4'>App Statistics</Text>
          <View className='bg-stone-800 rounded-xl p-4'>
            <View className='grid grid-cols-2 gap-4'>
              {appStats.map((stat, index) => (
                <View key={index} className='bg-stone-700 rounded-xl p-4 items-center'>
                  <Text className='text-[#CBFD03] text-2xl font-bold'>{stat.value}</Text>
                  <Text className='text-gray-400 text-sm text-center mt-1'>{stat.label}</Text>
                </View>
              ))}
            </View>
          </View>
        ...
        <View className='w-full bg-stone-800 rounded-xl p-6'>
          <Text className='text-white text-xl font-bold mb-4'>About Expense Tracker</Text>
        ...
        {/* Key Features */}
        <View className='w-full'>
          <Text className='text-white text-xl font-bold mb-4'>Key Features</Text>
          <View className='bg-stone-800 rounded-xl p-4 gap-3'>
            {appFeatures.map((feature) => {
              const IconComponent = feature.icon;
              return (
                <View key={feature.id} className='flex-row items-start gap-3 p-3 rounded-lg bg-stone-700'>
                  <View className='bg-stone-600 rounded-full p-2 mt-1'>
                    <IconComponent name={feature.iconName as any} size={20} color={feature.color} />
                  </View>
                  <View className='flex-1'>
                    <Text className='text-white text-base font-semibold'>{feature.title}</Text>
                    <Text className='text-gray-400 text-sm mt-1'>{feature.description}</Text>
                  </View>
                </View>
              );
            })}
        ...
        {/* Development Team */}
        <View className='w-full'>
          <Text className='text-white text-xl font-bold mb-4'>Our Team</Text>
          <View className='bg-stone-800 rounded-xl p-4 gap-4'>
            {teamMembers.map((member, index) => (
              <View key={index} className='flex-row items-start gap-3 p-3 rounded-lg bg-stone-700'>
                <View className='bg-[#CBFD03] rounded-full w-12 h-12 items-center justify-center'>
                ...
                <View className='flex-1'>
                  ...
                  <Text className='text-[#CBFD03] text-sm font-semibold'>{member.role}</Text>
                  <Text className='text-gray-400 text-sm mt-1'>{member.description}</Text>
                </View>
              </View>
            ))}
          </View>
        ...
        <View className='w-full'>
          <Text className='text-white text-xl font-bold mb-4'>Technical Information</Text>
          <View className='bg-stone-800 rounded-xl p-4 gap-3'>
            <View className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
              <Text className='text-white text-base'>Platform</Text>
              <Text className='text-gray-400 text-sm'>React Native / Expo</Text>
            </View>
            <View className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
              <Text className='text-white text-base'>Minimum OS Version</Text>
              <Text className='text-gray-400 text-sm'>iOS 13.0 / Android 8.0</Text>
            </View>
            <View className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
              <Text className='text-white text-base'>App Size</Text>
              <Text className='text-gray-400 text-sm'>45.2 MB</Text>
            </View>
            <View className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
              <Text className='text-white text-base'>Last Updated</Text>
              <Text className='text-gray-400 text-sm'>{new Date().toLocaleDateString()}</Text>
            </View>
          </View>
        </View>
        ...
        {/* Links and Actions */}
        <View className='w-full'>
          <Text className='text-white text-xl font-bold mb-4'>More Information</Text>
          <View className='bg-stone-800 rounded-xl p-4 gap-3'>
            <TouchableOpacity className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
            ...
            <TouchableOpacity className='flex-row items-center justify-between p-3 rounded-lg bg-stone-700'>
              <View className='flex-row items-center gap-3'>
                <Feather name="github" size={20} color="#CBFD03" />
