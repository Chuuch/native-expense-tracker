...
export default function LegalSettings({ legalItems, handleSettingPress }: { legalItems: any, handleSettingPress: (id: string) => void }) {
  const { colors } = useTheme();
  return (
    <View className='w-full'>
          <Text className={`${colors.text} text-xl font-bold mb-4`}>Legal</Text>
