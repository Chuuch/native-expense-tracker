        ...
        >
          ...
          <View className='absolute top-0 right-0 w-full h-full opacity-20'>
            ...
            <View className='absolute -top-8 -right-8 w-40 h-40 transform rotate-45'>
              <View className='w-full h-0.5 bg-[#615eff] opacity-60'></View>
              <View className='w-full h-0.5 bg-[#615eff] opacity-40 mt-8'></View>
              <View className='w-full h-0.5 bg-[#615eff] opacity-30 mt-16'></View>
            </View>
            ...
            <View className='absolute top-4 right-4 w-24 h-24 opacity-30'>
              <View className='w-0 h-0 border-l-8 border-t-8 border-r-8 border-transparent border-t-[#615eff]'></View>
              <View className='w-0 h-0 border-l-8 border-b-8 border-r-8 border-transparent border-b-[#615eff] mt-4'></View>
              <View className='w-0 h-0 border-l-8 border-t-8 border-r-8 border-transparent border-t-[#615eff] mt-4'></View>
            </View>
            
            {/* Modern Circular Accents */}
            <View className='absolute top-0 right-0 w-28 h-28 opacity-15'>
              <View className='w-full h-full rounded-full bg-[#615eff]' style={{
                shadowColor: '#615eff',
          ...
          <View className='flex-row items-center justify-between mb-2'>
            ...
            <View className='flex-row items-center gap-1'>
              <View className='w-8 h-6 bg-[#615eff] rounded-sm'></View>
          ...
          <View className='mb-6'>
            ...
            <Text className='text-[#615eff] text-3xl font-bold'>
          ...
          <View className='flex-row items-center justify-between'>
            ...
            <View className='flex-row items-center gap-2'>
              ...
              <Text className='text-[#615eff] text-xs font-semibold'>+$125.50</Text>
            </View>
          </View>
        </TouchableOpacity>
    </View>
